...
<head>
    ...
    <title>Sales Reports | Janta Mattress</title>
                        ...
                        <div class="sparkline12-list">
                            ...
                            <div class="sparkline12-graph">
                             ...
                             <div class="row">
                               ...
                               <form action="sales-reports-detailed.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group-inner">
                                  <div class="row">
                                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                  <label class="login2 pull-right pull-right-pro">Request Type:</label>
                                                            </div>
                                 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
