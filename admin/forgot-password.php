...
<head>
       <title>Forgot Password | Janta Mattress</title>
    ...
    <div class="container-fluid">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="#" id="login" method="post" name="login">
                            ...
                            <button class="btn btn-success btn-block loginbtn" name="login" type="submit">Reset</button>
        ...
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <p style="color: blue">Online Furniture Store Management System @ <?php echo date('Y');?>.</p>
            </div>
        </div>
    </div>
