...
$images=md5($images).time().$extension;
 move_uploaded_file($_FILES["images"]["tmp_name"],"images/".$images);
  $sql="update tblbrand set Logo=:images where ID=:eid";
     $query = $dbh->prepare($sql);
     $query->bindParam(':images',$images,PDO::PARAM_STR);
     $query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();

echo '<script>alert("Brand Image has been updated")</script>';
...
<head>
    ...
    <title>Update Brand Image | Janta Mattress</title>
...
{               ?>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                 ...
                                 <input type="text" name="brandname" id="brandname" value="<?php echo $row->BrandName;?>" readonly="true" 
                                 class="form-control" />
                               </div>
                                </div>
                                </div>
                                 <div class="form-group-inner">
                                  <div class="row">
                                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                  <label class="login2 pull-right pull-right-pro">Old Brand Logo</label>
                                                            </div>
                                 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class="form-group-inner">
                                  <div class="row">
                                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                  <label class="login2 pull-right pull-right-pro">New Brand Logo</label>
                                                            </div>
                                 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
