...
<html>
<head>
<title>Janta Mattress | Order Page</title>
...
echo $status;
					   	...
					   	<div class="delivery">
							<a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?odid=<?php echo htmlentities($row->OrderNumber);?>');" title="Track order"><strong style="color: red">Track Order</strong></a>
